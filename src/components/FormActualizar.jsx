        ...
        <div className="flex flex-col items-center justify-center">
            <form onSubmit={actualizarUsuario} className="w-96 px-16 flex flex-col justify-center items-center">
                ...
                <input
                    ...
                    readOnly
                    className="outline-none rounded-lg pl-3 bg-transparent text-white py-1 w-full dark:bg-gray-800 cursor-not-allowed"
                />
                <label className="text-white block mt-4 w-full">Nombre:</label>
                <input
                    value={nombre}
                    onChange={(e) => setNombre(e.target.value)}
                    className="outline-none rounded-lg pl-3 bg-transparent text-white dark:bg-gray-800 py-1 w-full"
                />
